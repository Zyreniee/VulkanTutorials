...
namespace vkUtil {
	...
	*/
	void allocateBufferMemory(vkUtil::BufferOutputChunk& buffer, const BufferInputChunk& input);
	...
	*/
	BufferOutputChunk createBuffer(BufferInputChunk input);
	...
	*/
	void copyBuffer(vk::Buffer& srcBuffer, vk::Buffer& dstBuffer, vk::DeviceSize size, vk::Queue queue, vk::CommandBuffer commandBuffer);
}