...
sphereBuffer(logicalDevice, physicalDevice, sphereSize, vk::BufferUsageFlagBits::eStorageBuffer),
sceneBuffer(logicalDevice, physicalDevice, 64, vk::BufferUsageFlagBits::eUniformBuffer)
{
	this->height = height;
	this->width = width;
}
