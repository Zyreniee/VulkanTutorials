...
/*------------------- variables ----------------------*/
	...
	void createFramebuffers() {
		...
		for (size_t i = 0; i < swapchainImages.size(); ++i) {
			std::array<VkImageView, 3> attachments = { msColorImageView,depthImageView,swapchainImageViews[i] };
	...
	void createColorResources() {
		...
		createImage(swapchainExtent.width, swapchainExtent.height, 1,
			...
			VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, msColorImage, msColorImageMemory);
