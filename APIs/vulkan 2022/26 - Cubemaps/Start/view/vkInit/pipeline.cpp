...
void vkInit::PipelineBuilder::specify_depth_attachment(
	...
	attachmentDescriptions.insert(
		{ attachment_index, 
		make_renderpass_attachment(depthFormat, vk::ImageLayout::eDepthStencilAttachmentOptimal) 
		}
	);
...
void vkInit::PipelineBuilder::add_color_attachment(
	...
	attachmentDescriptions.insert(
		{ attachment_index,
		make_renderpass_attachment(format, vk::ImageLayout::ePresentSrcKHR)
		}
	);
	attachmentReferences.insert(
		{ attachment_index,
...
vk::AttachmentDescription vkInit::PipelineBuilder::make_renderpass_attachment(
	const vk::Format& format, vk::ImageLayout finalLayout) {
