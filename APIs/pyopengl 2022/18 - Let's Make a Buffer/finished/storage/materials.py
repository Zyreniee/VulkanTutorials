...
class Material:
    ...
    def clear(self) -> None:
        ...
        glTexSubImage2D(GL_TEXTURE_2D,0,0,0,size,size,GL_RGBA,GL_UNSIGNED_BYTE,self.clearColor)
    ...
    def writeTo(self) -> None:
        ...
        glActiveTexture(GL_TEXTURE0)
        glBindImageTexture(0, self.textures[self.detailLevel], 0, GL_FALSE, 0, GL_WRITE_ONLY, GL_RGBA8)
