...
class GraphicsEngine:
    ...
    def create_meshes(self):
        ...
        self.ebos[FULL_ATTRIBUTES] = glGenBuffers(1)
        glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, self.ebos[FULL_ATTRIBUTES])
    ...
    def render_scene_objects(self, scene):
        ...
        for obj in scene.lit_objects:
            ...
            base_vertex = self.offsets[FULL_ATTRIBUTES][obj.mesh_type][0]
            base_index = ctypes.c_void_p(self.offsets[FULL_ATTRIBUTES][obj.mesh_type][1])
            index_count = self.offsets[FULL_ATTRIBUTES][obj.mesh_type][2]
...
class Mesh:
    ...
    def __init__(self, filename: str):
        ...
        vertices, indices = self.loadMesh(filename)
