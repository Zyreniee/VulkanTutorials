...
ADVANCED_MATERIAL_FILENAMES = {
    WOOD_MATERIAL: "gfx/wood",
    MEDKIT_MATERIAL: "gfx/medkit",
    CLAYBRICK_MATERIAL: "gfx/ClayBrick",
    HOTEL_WALL_MATERIAL: "gfx/FancyHotelWallDirty",
    GLASS_WALL_MATERIAL: "gfx/GlassBottleWindow",
    PLASTER_MATERIAL: "gfx/LatheAndPlasterWall",
    MARBLE_BRASS_MATERIAL: "gfx/MarbleAndBrassDarkSymmetry",
    MARBLE_COLD_MATERIAL: "gfx/MarbleAndGoldTriangularTiles"
}

SIMPLE_MATERIAL_FILENAMES = {
    LIGHT_MATERIAL: "gfx/greenlight"
}
...
class GraphicsEngine:
    ...
    def setup_shaders(self):
        ...
        glUniform1f(
            glGetUniformLocation(self.lighting_shader, "material_count"), 
        ...
        glUniform1f(
            glGetUniformLocation(self.unlit_shader, "material_count"), 
    ...
    def query_shader_locations(self):
        ...
        self.materialIndexLoc["lit"] = glGetUniformLocation(self.lighting_shader, "material_index")
        ...
        self.materialIndexLoc["unlit"] = glGetUniformLocation(self.unlit_shader, "material_index")
    ...
    def render_scene_objects(self, scene):
        ...
        for obj in scene.lit_objects:
            glUniform1f(self.materialIndexLoc["lit"], obj.material_type - WOOD_MATERIAL)
        ...
        for obj in scene.unlit_objects:
            glUniform1f(self.materialIndexLoc["unlit"], obj.material_type - LIGHT_MATERIAL)
