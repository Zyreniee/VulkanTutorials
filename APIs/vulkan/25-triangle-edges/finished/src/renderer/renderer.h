...
private:
    ...
    */
    vk::DescriptorSetLayout clearDescriptorSetLayout, rasterizeDescriptorSetLayout;

    /**
    * @brief Describes the descriptor sets used by a pipeline
    */
    vk::PipelineLayout clearPipelineLayout, rasterizePipelineLayout;

    /**
    * @brief For allocating descriptor sets
    */
    vk::DescriptorPool clearDescriptorPool, rasterizeDescriptorPool;

    /**
    * @brief descriptor sets for each frame. The renderer owns them as
    * they don't change on swapchain recreation.
    */
    vk::DescriptorSet clearDescriptorSets[2];
    vk::DescriptorSet rasterizeDescriptorSets[2];
