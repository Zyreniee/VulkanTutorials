...
void Engine::make_pipeline_layouts() {
	...
	pipelineLayouts[PipelineType::eRasterizeSmallDepth] = renderLayout;
	pipelineLayouts[PipelineType::eRasterizeSmallColor] = renderLayout;
	pipelineLayouts[PipelineType::eRasterizeBigDepth] = renderLayout;
	pipelineLayouts[PipelineType::eRasterizeBigColor] = renderLayout;
}
...
void Engine::make_shaders() {
	...
	shaders[PipelineType::eRasterizeSmallDepth] = make_compute_shader(logicalDevice, "rasterize_depth", dldi,
		deviceDeletionQueue, layouts);

	shaders[PipelineType::eRasterizeSmallColor] = make_compute_shader(logicalDevice, "rasterize_color", dldi,
		deviceDeletionQueue, layouts);

	shaders[PipelineType::eRasterizeBigDepth] = make_compute_shader(logicalDevice, "rasterize_big_depth", dldi,
		deviceDeletionQueue, layouts);

	shaders[PipelineType::eRasterizeBigColor] = make_compute_shader(logicalDevice, "rasterize_big_color", dldi,
		deviceDeletionQueue, layouts);
}
