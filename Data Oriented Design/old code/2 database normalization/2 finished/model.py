...
def update_positions(
    ...
    for i in range(count):
        ...
        target_array = transforms[write_array]
...
@njit(cache = True)
def update_lights(
    lights: tuple[np.ndarray], positions: np.ndarray, 
    ...
    for i in range(count):
        ...
        light_data[index]     = x
        light_data[index + 1] = y
        light_data[index + 2] = z
...
class Scene:
    ...
    def __init__(self):
        ...
        self.eulers = np.array([], dtype=np.float32)
    ...
    def _make_cubes(self) -> None:
        ...
        for _ in range(200):
            ...
            self.positions[1] = np.append(self.positions[1], 0)
    ...
    def _make_lights(self) -> None:
        ...
        for _ in range(8):
            ...
            self.lights[0] = np.append(self.lights[0], (r, g, b, s))
